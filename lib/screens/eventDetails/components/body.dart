...
import 'package:bookario_manager/screens/eventDetails/event_details_viewmodel.dart';
...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<EventDetailsViewModel>.reactive(
      onModelReady: (viewModel) => viewModel.updateEvent(event: event),
              ...
              SingleChildScrollView(
                child: Column(
                  children: [
                    Stack(
                      children: [
                        Image.network(viewModel.currentEvent.eventThumbnail),
                        // HoveringBackButton(),
                      ],
                    ),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //             ),
                          //             SizedBox(height: 10),
                          //             ...List.generate(myCoupons.length,
                          //                 (index) {
                          //               return CouponCard(
                          //                   myCoupons: myCoupons,
                          //                   index: index);
...
//     try {
//       final response = await Networking.getData('coupons/get-coupon', {
...
//     try {
//       final response = await Networking.post('coupons/add-coupon', {
//         'eventId': widget.event['eventId'],
