...
//     try {
//       final response = await Networking.getData('bookings/get-event-bookings', {
...
//     try {
//       final response =
//           await Networking.getData('bookings/get-booking-by-code', {
...
//               if (showQRScanner) _buildQrView(context) else Container(),
//               if (qrDataFetched)
//                 ticketBooked
//                     ? Column(
//                         children: [
