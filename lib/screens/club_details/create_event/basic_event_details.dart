          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                child: GestureDetector(
                  ...
                  child: viewModel.coverPhoto != null
                      ...
                      : Container(
                          ...
                          height: 150,
                          child: const Center(child: Text('Add cover Photo')),
                        ),
                ),
              ),
              ...
              if (!viewModel.showRatio) ...[
                ...
                customNumberFormField("Female Count",
                    viewModel.femaleCountTextController, "Total Female Count"),
                customNumberFormField(
                    "Couples Count",
                    viewModel.couplesCountTextController,
                    "Total Couples Count"),
                customNumberFormField("Tables Count",
                    viewModel.couplesCountTextController, "Total table Count"),
              ] else
                Padding(
...
Future<void> _imgFromGallery(AddEventViewModel viewModel) async {
  final XFile? image = await ImagePicker()
      .pickImage(source: ImageSource.gallery, imageQuality: 50, maxHeight: 500);
  if (image != null) {
    viewModel.coverPhoto = File(image.path);
  }
}
